...
return [
    ...
    // Video uploads can be larger than regular files.
    // Note: PHP/server limits must still allow it.
    'max_video_upload_kb' => (int) env('CLOUD_MAX_VIDEO_UPLOAD_KB', 614400), // 600 MB
    ...
    // Max total video file size for Cloud uploads (chunked init).
    // 0 means: fall back to max_file_kb.
    'max_video_file_kb' => (int) env('CLOUD_MAX_VIDEO_FILE_KB', 614400), // 600 MB
