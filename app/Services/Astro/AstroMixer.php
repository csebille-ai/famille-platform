...
{
    /**
    * @param array{western_sign?:string,western_element?:string,chinese_animal?:string,chinese_element?:string,chinese_yin_yang?:string,ascendant_sign?:string} $base
    ...
    public static function mix(array $base): array
    {
        ...
        // Different ascendant/chinese will rotate the pool.
        $seed = implode('|', [$westSign, $asc, $animal, $chElement, $yy, $archetype]);
