...
class UserController extends Controller
{
    ...
    public function astro(Request $request, User $user): View
    {
        Gate::authorize('manage-users');
    ...
    public function inviteLink(Request $request, User $user)
    {
        Gate::authorize('manage-users');
        ...
        return redirect()->back()->with('invite_link', $acceptUrl);
    }
