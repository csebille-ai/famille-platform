    ...
    <script>
        (() => {
            ...
            const applyFix = () => {
                ...
                let cs = null;
                try {
                    cs = window.getComputedStyle(nav);
                } catch (e) {
                    cs = null;
                }
                ...
                const inViewport = rect && rect.bottom <= (window.innerHeight + 6) && rect.top < window.innerHeight;

                // If it isn't fixed or is pushed below the viewport, force it.
            ...
            const schedule = () => {
                requestAnimationFrame(() => requestAnimationFrame(applyFix));
            };
