<x-app-layout pageBgClass="bg-slate-50">
    ...
    <div class="max-w-6xl mx-auto px-0 sm:px-6 py-0 sm:py-6 space-y-4 sm:space-y-6">
        ...
        <div class="bg-white sm:rounded-2xl shadow-sm flex flex-col h-[calc(100dvh-var(--mobile-bottom-nav-h,4rem)-env(safe-area-inset-bottom))] sm:h-[calc(100vh-10rem)] sm:overflow-hidden">
            @php
