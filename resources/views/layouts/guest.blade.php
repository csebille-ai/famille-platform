...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 fam-page-bg">
            <div>
                <a href="/">
            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 fam-card overflow-hidden sm:rounded-2xl">
                {{ $slot }}
            </div>
        </div>
    </body>
